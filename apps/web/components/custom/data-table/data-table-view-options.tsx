          ...
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="icon" className="hidden md:flex">
                ...
                <span className="sr-only">{dict.common.table.actions.column}</span>
              </Button>
            </DropdownMenuTrigger>
          </TooltipTrigger>
          <TooltipContent>{dict.common.table.actions.column}</TooltipContent>
        </Tooltip>
      </TooltipProvider>
      <DropdownMenuContent align="end" className="w-[180px]">
        <DropdownMenuLabel>{dict.common.table.actions.column}</DropdownMenuLabel>
        <DropdownMenuSeparator />
        {table
          .getAllColumns()
