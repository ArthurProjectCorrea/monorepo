...
export function DataTableRowActions<TData>({
  ...
  const editDialogTitle = dict.common.dialogs.update_dialog.title.replace('{name}', itemTitle)
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            <DropdownMenuLabel>{dict.common.table.column_actions}</DropdownMenuLabel>
            <DropdownMenuSeparator />
            {onEdit && (
              <DropdownMenuItem
              ...
              >
                ...
                {dict.common.table.actions.update}
              </DropdownMenuItem>
            )}
            ...
            {onDelete && (
              <>
                ...
                >
                  ...
                  {dict.common.table.actions.delete}
                </DropdownMenuItem>
              </>
            )}
          </DropdownMenuContent>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="sr-only">{dict.common.table.actions.update}</span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>{dict.common.table.actions.update}</TooltipContent>
          </Tooltip>
        )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="sr-only">{dict.common.table.actions.delete}</span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>{dict.common.table.actions.delete}</TooltipContent>
          </Tooltip>
        )}
      </div>
    )
    ...
    <>
      ...
      {onEdit && EditForm && (
        <DataTableDialog
          ...
          description={dict.common.dialogs.update_dialog.description}
          dict={dict}
        >
